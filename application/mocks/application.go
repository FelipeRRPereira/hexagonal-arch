...
import (
	...
	application "github.com/feliperrpereira/go-hexagonal/application"
...
// MockProductPersisterInterface is a mock of ProductPersisterInterface interface.
type MockProductPersisterInterface struct {
	ctrl     *gomock.Controller
	recorder *MockProductPersisterInterfaceMockRecorder
}

// MockProductPersisterInterfaceMockRecorder is the mock recorder for MockProductPersisterInterface.
type MockProductPersisterInterfaceMockRecorder struct {
	mock *MockProductPersisterInterface
}

// NewMockProductPersisterInterface creates a new mock instance.
func NewMockProductPersisterInterface(ctrl *gomock.Controller) *MockProductPersisterInterface {
	mock := &MockProductPersisterInterface{ctrl: ctrl}
	mock.recorder = &MockProductPersisterInterfaceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductPersisterInterface) EXPECT() *MockProductPersisterInterfaceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductPersisterInterface) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductPersisterInterfaceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPersisterInterface)(nil).Get), id)
}

// Save mocks base method.
func (m *MockProductPersisterInterface) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPersisterInterfaceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersisterInterface)(nil).Save), product)
}
